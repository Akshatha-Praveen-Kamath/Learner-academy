...
import org.simplilearn.lms.service.SavedUserLogin;
...
public class SavedUserLoginController extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		SavedUserLogin.insert(user);
		req.setAttribute("msg", "User login Successfully");	
